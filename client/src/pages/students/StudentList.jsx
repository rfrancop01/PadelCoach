                      ...
                      <tr key={student.id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-center">
                          <div
                            ...
                            className={`relative inline-flex items-center h-6 w-11 cursor-pointer rounded-full transition-colors duration-300 ${student.user?.is_active ? 'bg-green-500' : 'bg-gray-300'
                              }`}
                          >
                            <span
                              className={`inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform duration-300 ${student.user?.is_active ? 'translate-x-6' : 'translate-x-1'
                                }`}
                            ></span>
                          </div>
                        </td>
